  ...
  >
    GET IN TOUCH
      ...
      <section className="flex flex-col items-center text-center py-24 bg-gradient-to-b from-gray-300 to-white">
        ...
        {/* Avatar Image */}
        <div className="mt-6 flex justify-center items-center items-center w-64 h-64 md:w-52 md:h-52 mx-auto">
        <Image
            src="/Geenenict.png"
            alt="Frans Geenen"
            width={1000} 
            height={1000} 
            className="self-center rounded-full border-4 object-cover w-[200px] h-[200px]"
          />
        </div>
      ...
      <section className="py-0 bg-white">
        <div className="max-w-6xl mx-auto text-center px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 mt-10">
            <img 
              src="https://images.squarespace-cdn.com/content/v1/65329494635176698cea5737/f0612a0c-e14a-4645-9680-589a0d1578ec/vanderlande_logo.png?format=300w" 
              alt="Vanderlande" className="h-14 transition" 
            />
            <img 
              src="https://images.squarespace-cdn.com/content/v1/65329494635176698cea5737/ce6aa4c4-ba50-4b4a-b68b-c323b4236b88/rechtspraak_logo.png?format=300w" 
              alt="Rechtspraak" className="h-14 transition" 
            />
            <img 
              src="https://images.squarespace-cdn.com/content/v1/65329494635176698cea5737/082042f5-a65d-492d-b801-26cac5543f6a/ASML-Logo.png?format=300w" 
              alt="ASML" className="h-14  transition" 
            />
            <img 
              src="https://images.squarespace-cdn.com/content/v1/65329494635176698cea5737/992c2810-67a1-427f-82c0-fdd8af6c3f92/belastingdienst_logo.png?format=300w" 
              alt="Belastingdienst" className="h-14  transition" 
            />
            <img 
              src="https://images.squarespace-cdn.com/content/v1/65329494635176698cea5737/6013590a-298d-4532-bc0d-b02d6d912f2c/zalando_logo.png?format=300w" 
              alt="Zalando" className="h-14 transition" 
            />
            <img 
              src="https://images.squarespace-cdn.com/content/v1/65329494635176698cea5737/6d5f8ef7-c6fc-4720-a1f3-219fc683d858/jeans_barn_logo.png?format=300w" 
